        ...
        <ul class="c-services">
            <div class="card bb-green">
                <li class="c-services__item">
                    ...
                    <p>{{ __('We provide you with the latest and established categories of businesses in the selected locality, personalized for you, to match your requirements.') }}
                    </p>
                </li>
            </div>
            <div class="card bb-green">
            ...
            <div class="card bb-green">
                <li class="c-services__item">
                    ...
                    <p>{{ __('A personalized chat room for the users! Users can come together to discuss and provide information to those seeking. Provides an interface where users can chat one- to- one or many -to- many. Helps in bringing our Diaspora community together.') }}
                    </p>
                </li>
            </div>
            <div class="card bb-green">
                <li class="c-services__item">
                    <h3><i class="fas fa-photo-video fa-1x mb-3 text-success"></i>&nbsp
                        {{ __('Upload pictures & videos') }}</h3>
                    <p>{{ __('Make your space all the more colorful. Diaspora provides you with the access to upload photos and videos of the city, local area or the businesses involved that will be of great assist to all the wanderers navigating  through our site.') }}
                    </p>
                </li>
            </div>
            <div class="card bb-green">
                <li class="c-services__item">
                    <h3><i class="fas fa-map-marker-alt fa-1x mb-3 text-success"></i>&nbsp
                        {{ __('Local businesses & attractions') }}</h3>
                    <p>{{ __('Find businesses and attractions around you. Check out their ratings and reviews and see their location and oprationg hours. Phone numbers are listed too.') }}
                    </p>
                </li>
            </div>
        </ul>
