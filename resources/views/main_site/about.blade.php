        ...
        <div class="container">
            <div class="flex-left" style="justify-content: space-between; align-items:center;">
                <div class="flex-column">
                    <h2 class="display-4">{{ __("Welcome to Diaspora") }}</h2>
                    <h4 class="lead text-muted">{{ __("Your space, your voice, your home.") }}</h4>
                </div>
        ...
        <div class="container py-5">
            <div class="row align-items-center mb-5">
                <div class="col-lg-6 order-2 order-lg-1"><i class="fas fa-map-marker-alt fa-2x mb-3 text-success"></i>
                    <h4 class="font-weight-light">{{ __("Find places around you.") }}</h4>
                    <p class="font-italic text-muted mb-4">{{ __("Moved to a new city? Feel at home, find things to do around you.") }}</p>
                    <a href="/"> <button class="btn btn-success text-white">{{ __("Start Now") }}</button>
                    </a>
                </div>
            ...
            <div class="row align-items-center mb-5">
                ...
                <div class="col-lg-6"> <i class="fas fa-comments fa-2x mb-3 text-success"></i>
                    <h4 class="font-weight-light">{{ __("Meet new people") }}</h4>
                    <p class="font-italic text-muted mb-4">{{ __("Diaspora is your passport to find some really cool place and interact with poeple.") }}</p>
                    <a href=""> <button class="btn btn-success text-white">{{ __("Chat Now") }}</button>
                    </a>
                </div>
            </div>
            <div class="row align-items-center mb-5">
