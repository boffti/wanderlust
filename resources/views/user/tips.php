...
<body>
    ...
    <section style="background-color: var(--primary-color); padding:50px 0;">
        <div class="container">
            <div class="flex-center" style="justify-content: space-between; align-items:center;">
                ...
                <br>
                <h2 class="display-4">Check out all the tips written by other people nearby. Definitely helpful.</h2>
            </div>
        </div>
    </section>
    ...
    <div class="container">
        <form action="../../php/tips_handler.php" method="POST" style="display:<?php echo $isDisplay ?>">
            <div class="flex-left">
                <textarea placeholder="Write a tip. Type here..." name="tip_content" id="bulletin_post" cols="30" rows="3"
        ...
        <div class="tips">
            <?php
                ...
                $conn = get_db_conn();
                $sql_city_tips = "SELECT tips.tip_id, tips.tip_content, users.user_id, users.full_name, cities.city_id, cities.city_name from tips, cities, users where tips.user_id=users.user_id and tips.city_id=cities.city_id and cities.city_id='{$_SESSION['user_loc']['city_id']}'";
