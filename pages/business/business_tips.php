...
<body>
    ...
    <div class="container">
        ...
        <section>
            <div class="flex-left" style="justify-content: space-between;">
                <div>
                    ...
                    <br>
                    <!-- <div>
                        <button class="btn" style="font-size: large;"><i class="far fa-star"
                        ...
                        <button class="btn btn-outline-secondary text-secondary" style="font-size: large;"><i
                                class="fas fa-camera" style="margin-right: 10px;"></i> Add Photo</button>
                        <button class="btn btn-outline-secondary text-secondary" style="font-size: large;"><i
                                class="fas fa-star" style="margin-right: 10px;"></i> Share</button>
                    </div> -->
                </div>
        ...
        <section>
            ...
            <form>
                <div class="flex-left">
                    <textarea placeholder="Write a tip. Type here..." name="post" id="bulletin_post" cols="30" rows="3"
